...
public class CompanyMetricWithParentDto
{
...
public static class CompanyMetricWithParentMapper
{
    public static CompanyMetricWithParentDto ToCompanyMetricDto(List<CompanyMetric> companyMetrics)
    {
        ...
        return new CompanyMetricWithParentDto()
        {
