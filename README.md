...
<div style="text-align:center">
    ...
    <img src="https://img.shields.io/badge/.NET-512BD4?logo=dotnet&logoColor=fff" alt=""/>
    <img src="https://img.shields.io/badge/Angular-%23DD0031.svg?logo=angular&logoColor=white" alt=""/>
...
The bulk of it lies under `apps/`, currently split between the backend and the client app.
